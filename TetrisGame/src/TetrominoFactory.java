...
public class TetrominoFactory {
	...
	private final static int START_X = (int) Math.ceil(TetrisGrid.GRID_WIDTH / 2.0); // starting position private final
	static int START_Y = 2;
	private static final Color[] tetrominoColors;
	static {
		tetrominoColors = new Color[] { Color.YELLOW, // O Color.CYAN, // I
				Color.GREEN, // S
				Color.RED, // Z
				Color.ORANGE, // L
				Color.BLUE, // J
